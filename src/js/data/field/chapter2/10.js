...
module.exports = {
	...
	background: "chapter2_10-bg-001",
	walkSound: "walking_bare_default",
	initialProcess: [
		{"type": "criteria", "value": "isPlayed", "arguments": ["chapter2_10_20260"], "process": [
			// すでにアクセス済み
			[],
			// まだ未アクセス
			[
				...
				{"type": "process", "value": "incrementPlayedFlag", "arguments": ["chapter2_10_20260"]}
			],
		]},
	...
	objects: [
		...
		},
		{
			...
			serif_back: [
				{"type": "criteria_serif", "criteria": "existsItem", "arguments": ["38"], "serifs": [
					...
					[
						...
						{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_02", "serif": _("ワ！")},
						{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_02", "serif": _("かわいいね！")},
						{"chara": "koishi", "exp": "3rdeye_yes", serif1: _("かわいーねー"), serif2: _("かわいーねー"), serif3: _("かわいーねー"), serif4: _("かわいーねー")},
						{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_05", "serif": _("えへへ")},
						...
						{"chara": "pars", "exp": null, "serif": _("んー？")},
						...
						{"chara": "pars", "exp": null, "serif": _("ほんとう！")},
						{"chara": "pars", "exp": null, "serif": _("うれしい")},
						...
						{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_02", "serif": _("えー")},
						{"chara": "pars", "exp": null, "serif": _("じゃあー")},
						{"chara": "pars", "exp": null, "serif": _("なぞなぞね！")},
						{"chara": "koishi", "exp": "3rdeye_look_front", serif1: _("なぞなぞ？"), serif2: _("なぞなぞ？"), serif3: _("なぞなぞ？"), serif4: _("なぞなぞ？")},
						{"chara": "pars", "exp": null, "serif": _("あなたがー")},
						{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_02", "serif": _("ほしいもの！")},
						{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_03", "serif": _("を見せてほしい")},
					...
					[
						{"type": "criteria_serif", "criteria": "existsItem", "arguments": ["39"], "serifs": [
							...
							[
								...
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_02", "serif": _("オオ")},
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_04", "serif": _("やるじゃないの")},
								...
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_02", "serif": _("わたしはこれがすきなの")},
								...
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_wait", "serif": _("は？")},
								...
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_01", "serif": _("そんな約束してないだろ！")},
								{"chara": "koishi", "exp": "look_bottom", serif1: _("えー"), serif2: _("えー"), serif3: _("えー"), serif4: _("えー")},
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_wait", "serif": _("次はー")},
								{"chara": "pars", "exp": null, "serif": _("そうだなー")},
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_02", "serif": _("かわいいもの")},
								{"chara": "pars", "exp": null, "serif": _("がほしいな！")},
								{"chara": "koishi", "exp": "look_top", serif1: _("かわいいものってどんなの"), serif2: _("かわいいものってどんなの"), serif3: _("かわいいものってどんなの"), serif4: _("かわいいものってどんなの")},
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_wait", "serif": _("それは自分で考えなさいよ")},
							...
							[
								//20290
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_wait", "serif": _("なんだ！")},
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_01", "serif": _("おいおいおいおい")},
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_01", "serif": _("おまえ～！")},
								{"chara": "pars", "exp": null, "serif": _("へんなやつだな！")},
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_02", "serif": _("ハハハ")},
								{"chara": "pars", "exp": null, "serif": _("なにしてんだ")},
								...
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_01", "serif": _("私と？")},
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_03", "serif": _("へーえ")},
								{"chara": "pars", "exp": null, "serif": _("たのしいのか？")},
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_wait", "serif": _("私はおまえと遊んで")},
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_03", "serif": _("おまえが私と遊んで")},
								{"chara": "koishi", "exp": "3rdeye_yes", serif1: _("たのしいよ！"), serif2: _("たのしいよ！"), serif3: _("たのしいよ！"), serif4: _("たのしいよ！")},
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_03", "serif": _("どうなんだろうな～～")},
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_02", "serif": _("私のこと何も知らないくせに")},
								...
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_02", "serif": _("ほらな～～")},
								{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_01", "serif": _("失せな"), "option": {"playEvent": "chapter2-04-event-01"}},
								...
								{"type": "junction_serif", "serifs": [
									...
									[
										...
										{"chara": "pars", "exp": "cp2_pars_greendog-ura_wait", "serif": _("フーーーーーン")},
										{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_03", "serif": _("それじゃあねえ！")},
										{"chara": "pars", "exp": "cp2_pars_greendog-ura_wait", "serif": _("釘を取ってきてちょうだい")},
										...
										{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_02", "serif": _("何でもよ")},
										{"chara": "koishi", "exp": "3rdeye_look_top", serif1: _("釘が好きなの？"), serif2: _("釘が好きなの？"), serif3: _("釘が好きなの？"), serif4: _("釘が好きなの？")},
										{"chara": "pars", "exp": "cp2_pars_greendog-ura_reaction_02", "serif": _("そうさ")},
			...
			serif: [
				{"type": "criteria_serif", "criteria": "limit", "arguments": ["chapter2_10-pars-limit", 2], "serifs": [
					// 最初に喋りかけたとき
					[
						//20270
					...
					[
						...
						{"type": "criteria_serif", "criteria": "isPlayed", "arguments": ["chapter2_10-20480"], "serifs": [
							...
							[
								...
								{"type": "criteria_serif", "criteria": "isPlayed", "arguments": ["chapter2_09_20581"], "serifs": [
									[
										//20590
									...
									[
										...
										{"chara": "pars", "exp": "cp2_pars-reaction_03", "serif": _("ありがとう……")},
