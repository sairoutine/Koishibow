...
AssetsConfig.images = {
	...
	// ムラサ
	"cp2_murasa":   "./image/production/cp2_murasa.png",
	// パルスィ表
	"cp2_pars":   "./image/production/cp2_pars.png",
	// パルスィ裏(緑の犬)
	"cp2_pars_greendog":   "./image/production/cp2_pars_greendog.png",
    
	// 2-1 こいしが起きる
	"chapter2-01-event-01-koishi":  "./image/production/chapter2/event/chapter2-01-event-01/chapter2-01-event-01-koishi.png",
	"chapter2-01-event-01-obj-01":  "./image/production/chapter2/event/chapter2-01-event-01/chapter2-01-event-01-obj-01.png",
    
	// 2-4-1
	"chapter2-04-event-01-koishi":  "./image/production/chapter2/event/chapter2-04-event-01/chapter2-04-event-01-koishi.png",
	"chapter2-04-event-01-mobu":  "./image/production/chapter2/event/chapter2-04-event-01/chapter2-04-event-01-mobu.png",
      
	// 2-9-3
	"chapter2-09-event-03-koishi":  "./image/production/chapter2/event/chapter2-09-event-03/chapter2-09-event-03-koishi.png",
	"chapter2-09-event-03-obj":  "./image/production/chapter2/event/chapter2-09-event-03/chapter2-09-event-03-obj.png",
      
	// 2-10-1
	"chapter2-10-event-01-koishi":  "./image/production/chapter2/event/chapter2-10-event-01/chapter2-10-event-01-koishi.png",
	"chapter2-10-event-01-pars":  "./image/production/chapter2/event/chapter2-10-event-01/chapter2-10-event-01-pars.png",
	"chapter2-10-event-01-obj":  "./image/production/chapter2/event/chapter2-10-event-01/chapter2-10-event-01-obj.png",
      
	// 2-10-2
	"chapter2-10-event-02-koishi":  "./image/production/chapter2/event/chapter2-10-event-02/chapter2-10-event-02-koishi.png",
	"chapter2-10-event-02-pars":  "./image/production/chapter2/event/chapter2-10-event-02/chapter2-10-event-02-pars.png",
	"chapter2-10-event-02-obj":  "./image/production/chapter2/event/chapter2-10-event-02/chapter2-10-event-02-obj.png",
	...
	"chapter2-07-bg-001": "./image/production/chapter2/chapter2-07/chapter2-07-bg-001.png",
	"chapter2-07-obj-01": "./image/production/chapter2/chapter2-07/chapter2-07-obj-01.png",
	"chapter2-08-bg-001": "./image/production/chapter2/chapter2-08/chapter2-08-bg-001.png",
	"chapter2-08-obj-01": "./image/production/chapter2/chapter2-08/chapter2-08-obj-01.png",
